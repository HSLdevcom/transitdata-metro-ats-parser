...
public class MessageHandler implements IMessageHandler {
    ...
    public void handleMessage(Message received) throws Exception {
        try {
            if (TransitdataSchema.hasProtobufSchema(received, ProtobufSchema.MqttRawMessage)) {
                final Optional<MetroAtsProtos.MetroEstimate> maybeMetroEstimate = metroEstimatesFactory
                        .toMetroEstimate(received);
    ...
    private void sendPulsarMessage(MessageId received, MetroAtsProtos.MetroEstimate estimate, long timestamp,
            String key) {
